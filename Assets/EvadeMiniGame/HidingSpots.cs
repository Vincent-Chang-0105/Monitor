...
public class HidingSpots : MonoBehaviour, IPointerClickHandler
{
    public static HidingSpots current = null;

    [SerializeField] private bool is_starting = false;
    [SerializeField] private List<HidingSpots> connected;
